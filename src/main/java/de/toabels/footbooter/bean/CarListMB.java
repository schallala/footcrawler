package de.toabels.footbooter.bean;

import de.toabels.footbooter.infra.model.Filter;
import de.toabels.footbooter.model.Car;
import de.toabels.footbooter.service.CarService;
...
import static de.toabels.footbooter.util.Utils.addDetailMessage;
    ...
    public void initDataModel() {
        cars = new LazyDataModel<Car>() {
            ...
            public List<Car> load(int first, int pageSize,
                ...
                de.toabels.footbooter.infra.model.SortOrder order = null;
                if (sortOrder != null) {
                    order = sortOrder.equals(SortOrder.ASCENDING) ? de.toabels.footbooter.infra.model.SortOrder.ASCENDING
                            : sortOrder.equals(SortOrder.DESCENDING) ? de.toabels.footbooter.infra.model.SortOrder.DESCENDING
                            : de.toabels.footbooter.infra.model.SortOrder.UNSORTED;
                }
